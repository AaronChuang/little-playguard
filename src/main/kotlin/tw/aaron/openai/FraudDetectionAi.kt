...
@RegisterAiService(tools = [TransactionRepo::class, CustomerRepo::class])
interface FraudDetectionAi {
    @SystemMessage(
        """
    ...
    fun detectAmountFraudForCustomer(customerId: Long): String
    ...
    @Timeout(value = 2, unit = ChronoUnit.MINUTES)
    fun detectDistanceFraudForCustomer(customerId: Long): String
}
